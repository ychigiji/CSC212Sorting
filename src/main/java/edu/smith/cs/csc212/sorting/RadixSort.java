...
public class RadixSort {
	 ...
	 * 
	 * Also, the constants are insane! It's O(256 * 4n) at least and it uses a lot of small lists to do its job.
	 * 
	...
	public static ListADT<Integer> sort(ListADT<Integer> input) {
		...
		for (int step = 0; step < 4; step++) {
			...
			for (int x : current) {
				...
				// Put the numbers directly in the appropriate bucket (now they're sorted by that digit)!
